...
export class SmsRateLimitService {
  ...
  private static readonly LIMITS = {
    ...
    perPhone: {
      otp: { count: 3, windowSeconds: 3600 }, // 3 OTPs per hour per phone
      delivery: { count: 10, windowSeconds: 86400 }, // 10 delivery SMS per day
      booking: { count: 5, windowSeconds: 86400 }, // 5 booking SMS per day
      promotional: { count: 2, windowSeconds: 86400 }, // 2 promotional per day
      transactional: { count: 20, windowSeconds: 86400 }, // 20 total per day
    },
